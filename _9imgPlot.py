...
if __name__ == '__main__':
    ...
    tmp nontmp GO
    '''
    fins = ['file/5statistic/positive/12TmpGORatio.tsv',
    'file/5statistic/positive/12nonTmpGORatio.tsv'
   ]
    names = ['12TmpGORatio','12nonTmpGORatio']

    f7proteinType = os.path.join(foutdir, '9GO_overlap.png')
    plotVenn(fins, names, f7proteinType)
