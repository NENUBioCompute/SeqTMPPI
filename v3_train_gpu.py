...
# CPU 19jjhnenu to jiangjiuhong
# running nohup python v3_train_gpu.py >0706_humanmodel
...
def crossTrain(f2out,dirout_feature,f2resultOut,modelreuse=True):
    ...
    for cv in range(5):
        ...
        # dirout_result_test = '/home/jiangjiuhong/Data/Phsi_Blos/result/5CV_1_test/%d'%cv
        ...
        # dirout_feature = '/home/jiangjiuhong/Data/Phsi_Blos/feature/%s/' % 'DIP'
        # fin_model = os.path.join(f2dirout, oldfile, '_my_model.h5')
        # dirout_result_test = '/home/jiangjiuhong/Data/Phsi_Blos/result/benchmark_human/test/5CV_1_DIP/%d' % cv
        # check_path(dirout_result_test)
        ...
        # dirout_feature = '/home/jiangjiuhong/Data/Phsi_Blos/feature/%s/' % 'DIP'
        # fin_model = os.path.join(f2dirout, oldfile, '_my_model.h5')
        # dirout_result_test = '/home/jiangjiuhong/Data/Phsi_Blos/result/benchmark_human/test/5CV_1_DIP_posi/%d' % cv
        # check_path(dirout_result_test)
        # savepredict(fin_test, dirout_feature, fin_model, dirout_result_test, batch_size=500,onehot = onehot)
        ...
        # dirout_feature = '/home/jiangjiuhong/Data/Phsi_Blos/feature/%s/' % 'IMEx'
        # fin_model = os.path.join(f2dirout, oldfile, '_my_model.h5')
        # dirout_result_test = '/home/jiangjiuhong/Data/Phsi_Blos/result/benchmark_human/test/5CV_1_IMEx_posi/%d' % cv
        # check_path(dirout_result_test)
        # savepredict(fin_test, dirout_feature, fin_model, dirout_result_test, batch_size=500,onehot = onehot)
        ...
        # dirout_feature = '/home/jiangjiuhong/Data/Phsi_Blos/feature/%s/' % 'IMEx'
        # fin_model = os.path.join(f2dirout, oldfile, '_my_model.h5')
        # dirout_result_test = '/home/jiangjiuhong/Data/Phsi_Blos/result/benchmark_human/test/5CV_1_IMEx/%d' % cv
        # check_path(dirout_result_test)
        # savepredict(fin_test, dirout_feature, fin_model, dirout_result_test, batch_size=500,onehot = onehot)
        '''
        ...
        #     dirout_feature = '/home/jiangjiuhong/Data/Phsi_Blos/feature/%s/' % 'DIP'
        #     fin_model = os.path.join(f2dirout, oldfile, '_my_model.h5')
        #     dirout_result_test = '/home/jiangjiuhong/Data/Phsi_Blos/result/benchmark_human/test/5CV_1_DIP_%s/%d' % (eachfile,cv)
        #     check_path(dirout_result_test)
        #     savepredict(fin_test, dirout_feature, fin_model, dirout_result_test, batch_size=500,onehot = onehot)
        ...
        #     dirout_feature = '/home/jiangjiuhong/Data/Phsi_Blos/feature/%s/' % 'DIP'
        #     fin_model = os.path.join(f2dirout, oldfile, '_my_model.h5')
        #     dirout_result_test = '/home/jiangjiuhong/Data/Phsi_Blos/result/benchmark_human/test/5CV_1_DIP_%s_+-/%d' % (eachfile,cv)
        #     check_path(dirout_result_test)
        #     savepredict(fin_test, dirout_feature, fin_model, dirout_result_test, batch_size=500,onehot = onehot)
...
if __name__ == '__main__':
    ...
    # dir_feature_db = '/home/jiangjiuhong/Data/Phsi_Blos/featuredb/%s/' % eachdir
    # dirout_feature = '/home/jiangjiuhong/Data/Phsi_Blos/feature/%s/' % eachdir
    ...
    eachdir = 'benchmark_human'
    dirout = '/home/jiangjiuhong/Data/Phsi_Blos/result/%s/' % eachdir
    check_path(dirout)
    ...
    # dirout = '/home/jiangjiuhong/Data/Phsi_Blos/result/%s/' % 'testall'
    ...
    # fin_pair = 'file/4train/0/test.txt'
    # dir_in = dirout_feature
    # fin_model = '/home/jiangjiuhong/Data/SeqTMPPI2W/result/129878/_my_model.h5'
    # dirout_result = '/home/jiangjiuhong/Data/SeqTMPPI2W/result/129878/test'
    # check_path(dirout_result)
    # savepredict(fin_pair, dir_in, fin_model, dirout_result,batch_size=500)

    # dirout = '/home/jiangjiuhong/Data/Phsi_Blos/result/5CV_1_test'
    # dirout = '/home/jiangjiuhong/Data/Phsi_Blos/result/5CV_1_IMEx_posi'
    # dirout = '/home/jiangjiuhong/Data/Phsi_Blos/result/5CV_1_DIP_posi'
    # dirout = '/home/jiangjiuhong/Data/Phsi_Blos/result/5CV_1_DIP'

    # dirA = ['5CV_1_test','5CV_1_IMEx_posi','5CV_1_DIP_posi']
    # dirB = ['5CV_1_DIP_%s'%x for x in ['Ecoli', 'Human', 'Mus', 'SC']]
    # dirA.extend(dirB)
    # for eachfile in dirA:
    #     dirout = '/home/jiangjiuhong/Data/Phsi_Blos/result/%s'%eachfile
    #     calculateResults(dirout,dirout,filename='log.txt',row=2)

    # for eachfile in ['Ecoli', 'Human', 'Mus', 'SC']:
    #     dirout = '/home/jiangjiuhong/Data/Phsi_Blos/result/5CV_1_DIP_%s_+-/' % (eachfile)
    #     calculateResults(dirout, dirout, filename='log.txt', row=2)
    ...
    # data = np.load('/home/jiangjiuhong/Data/Phsi_Blos/featuredb/benchmark/A0A0B4J1F4.npy')
    # data = np.load('/home/jiangjiuhong/Data/Phsi_Blos/feature/benchmark/Q9UYS2_P58552.npy')
    # data = np.load('/home/jiangjiuhong/Data/SeqTMPPI2W/feature/129878/Q9UYS2_P58552.npy')
